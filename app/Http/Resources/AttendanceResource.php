...
class AttendanceResource extends JsonResource
{
    ...
    public function toArray(Request $request)
    {
        return [
            ...
            'check_in_time' => $this->check_in_time ? $this->check_in_time->format('Y-m-d H:i:s') : null,
            'check_out_time' => $this->check_out_time ? $this->check_out_time->format('Y-m-d H:i:s') : null,
            ...
            'shift' => new ShiftResource($this->employee->shift)
        ];
    }
