...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* MONTH BADGE ROW */
        .meta-row-table { width: 100%; margin-bottom: 20px; margin-top: 18px; }
        .meta-row-table td { vertical-align: middle; padding: 0; }
        .month-badge { display: inline-block; background-color: #f1f5f9; border-radius: 8px; padding: 10px 16px; font-size: 11px; font-weight: 700; color: #0f172a; }
        .month-badge-sub { font-size: 9px; font-weight: 400; color: #64748b; margin-top: 2px; }
        .days-pill { display: inline-block; background-color: #e0f2fe; color: #0369a1; font-size: 9px; font-weight: 700; padding: 4px 12px; border-radius: 99px; }

        /* CARDS */
        .cards-table { width: 100%; margin-bottom: 22px; }
        .cards-table td { width: 25%; padding-right: 8px; vertical-align: top; }
...
<table class="header-table" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td class="header-org">
            ...
            <div class="org-subtitle">Monthly Summary</div>
        </td>
        <td class="header-meta">
            <div class="meta-label">Month</div>
            <div class="meta-date">{{ $data['monthLabel'] }}</div>
            <div class="meta-sub">{{ $data['totalDays'] }} school days</div>
...
<div class="body">
    ...
    {{-- Month info row --}}
    <table class="meta-row-table" cellspacing="0" cellpadding="0">
        <tr>
            <td>
                <div class="month-badge">
                    {{ $data['monthLabel'] }}
                    <div class="month-badge-sub">Monthly attendance breakdown by grade</div>
                </div>
            </td>
            <td style="text-align:right;">
                <span class="days-pill">{{ $data['totalDays'] }} school days</span>
            </td>
        </tr>
    </table>
