...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header-meta { text-align: right; width: 190px; }
...
<table class="header-table" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td class="header-org">
            ...
            <div class="org-subtitle">Daily Check-in Summary</div>
        </td>
        <td class="header-meta">
            <div class="meta-label">Report Date</div>
            <div class="meta-date">{{ \Carbon\Carbon::parse($data['date'])->format('d F Y') }}</div>
            <div class="meta-sub">{{ \Carbon\Carbon::parse($data['date'])->format('l') }}</div>
