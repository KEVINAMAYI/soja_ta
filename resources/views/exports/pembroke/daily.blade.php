...
<div class="header">
    <div class="header-left">
        ...
        <div class="report-title">Daily Check-in Summary</div>
    </div>
    <div class="header-right">
        Generated: {{ now()->format('d M Y, H:i') }}<br>
        Date: {{ \Carbon\Carbon::parse($data['date'])->format('l, d F Y') }}
    </div>
</div>

<div class="summary-row">
    <div class="summary-card" style="background:#dcfce7;">
        <div class="num" style="color:#16a34a;">{{ $data['totals']['present'] }}</div>
        <div class="lbl" style="color:#16a34a;">In School</div>
    </div>
    <div class="summary-card" style="background:#fef9c3;">
        <div class="num" style="color:#d97706;">{{ $data['totals']['departed'] }}</div>
        <div class="lbl" style="color:#d97706;">Left School</div>
    </div>
    <div class="summary-card" style="background:#fee2e2;">
        <div class="num" style="color:#dc2626;">{{ $data['totals']['notIn'] }}</div>
        <div class="lbl" style="color:#dc2626;">Not Reported</div>
    </div>
    <div class="summary-card" style="background:#f1f5f9;">
        <div class="num" style="color:#475569;">{{ $data['totals']['total'] }}</div>
        <div class="lbl" style="color:#475569;">Total Enrolled</div>
    </div>
    <div class="summary-card" style="background:#ede9fe;">
        <div class="num" style="color:#7c3aed;">{{ $data['totals']['rate'] }}%</div>
        <div class="lbl" style="color:#7c3aed;">Attendance Rate</div>
    </div>
</div>
