...
<div class="row">
    <div class="col-12">
        ...
        'icon'  => '<iconify-icon icon=\'mdi:calendar-clock\' class=\'fs-6\'></iconify-icon>',
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const initCollapseToggles = () => {
                document.querySelectorAll(".collapse-toggle").forEach((toggle) => {
                    ...
                    target.removeEventListener("show.bs.collapse", null);
                    target.removeEventListener("hide.bs.collapse", null);
            ...
            // Reinitialize collapse toggles after Livewire updates
            Livewire.hook('morph.updated', () => {
                initCollapseToggles();
            });

            // Also reinitialize after message processing (for older Livewire versions)
