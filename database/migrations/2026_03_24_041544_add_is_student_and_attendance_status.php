...
return new class extends Migration
{
    ...
    {
        // 1. Add is_student flag
        Schema::table('employees', function (Blueprint $table) {
            if (!Schema::hasColumn('employees', 'is_student')) {
    ...
    ");
        ...
        // 3. Updated ENUM (Now including 'on_break')
        DB::statement("
        ...
        MODIFY COLUMN status ENUM(
            ...
            'off_shift',
            'sick_off',
            'on_break',     -- <--- Added this to match your UI
            'not_scheduled',
            'on_trip',
            'with_parent',
            'signed_out',
